        ...
        <div class="container">
            <div class="detail-layout">
                ...
                <div class="info-section">
                    <h1 class="podcast-title">Bloom Beyond Silence</h1>
                    <p class="podcast-producer">SHE Originals</p>

                    <div class="podcast-meta">
                        <span class="rating">⭐ {{ averageRating.toFixed(1) }} ({{ totalRatings }})</span>
                        <span class="category">HEALING</span>
                        <span class="series">WEEKLY SERIES</span>
                    </div>

                    <p class="podcast-description">
                        A gentle journey through healing and growth. Discover stories of resilience, self-compassion,
                        and the beautiful
                        process of finding your voice again after silence. A safe space for healing hearts and blooming
                        souls.
                    </p>
...
import episodesData from '@/data/bloom-beyond-silence-episodes.json'
